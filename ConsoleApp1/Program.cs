...
namespace ConsoleApp1
{
	...
	internal class Program
	{
		...
		static void DisplayMenu()
		{
            ...
            switch (consoleKeyInfo.Key)
            {
                case ConsoleKey.D1://Display the phone book
                    ...
                    try
                    {
                        DispleyPhonBook(GetStringArrayFromFile(pathPhoneBook));
        ...
        static void AddNewContact()
        {
            ...
            string lastName = Console.ReadLine()?? "NullReferenceException";

            Console.Write("Firs name:\t");
            string firstName = Console.ReadLine()?? "NullReferenceException";

            Console.Write("Phon nuber:\t");
            string phon = Console.ReadLine() ?? throw new NullReferenceException();
        ...
        static void SortAscDesc()
        {
            ...
            {
                Exception ex = new Exception("trabl with file", exep.InnerException);
                Exception ex1 =new Exception("Excep.",ex.InnerException);
                throw ex1;
            }
        }
        //
        static void BinarySearch()
        {
            ...
            string nameFound = Console.ReadLine()??throw new NullReferenceException();
