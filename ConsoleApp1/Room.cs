...
namespace ConsoleApp1
{
    ...
    {
        private string name;
        private Dictionary<TimeSpan, bool> freeHours = new Dictionary<TimeSpan, bool>
        {
        ...
        /// <summary>
        /// Show free time for meetings
        /// </summary>
        //public void ShowMeetings(RoomStatus roomStatus)
        //{
        //    bool isFree = roomStatus == 0 ? false : true;
        //    string status = isFree == true ? "available" : "occupied";

        //    for (int i = 0; i < freeHours.Count; i++)
        //    {
        //        if (freeHours.ElementAt(i).Value == isFree && i != freeHours.Count-1) 
        //        {
